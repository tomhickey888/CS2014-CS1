...
//          then calculates and displays that employee's weekly paycheck.
...
int main()
{
  ...
  cout << endl << "To calculate an employee paycheck, enter employee ID (or -1 to quit)" << endl;
